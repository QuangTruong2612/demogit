    ...
    <section class="login-section section-padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="rol-md-7 col-lg-6 col-xl-5">
                    <div class="login-form box">
                        ...
                        <form action="<?php echo $_SERVER["PHP_SELF"];?>">
                            ...
                            <div class="form-group">
                                <div class="d-flex mb-2 justify-content-center "><a href="#">Quên mật khẩu ?</a></div>
                                <input type="password" class="form-control" placeholder="Password">
                                </div>
                            <button type="submit" class="btn btn-theme btn-lock btn-form">Đăng nhập</button>
                            <p class="text-center mt-4 mb-0">Không có tài khoản ? <a href="sign-up.php">Đăng kí</a></p>
