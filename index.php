          ...
          <ul class="menu">
            ...
            <li class="menu-item menu-item-has-children">
              ...
              <ul class="sub-menu js-sub-menu">
                ...
                <li class="sub-menu-item text-center"><a href="courses.php">AD</a></li>
                <li class="sub-menu-item text-center"><a href="courses.php">DA</a></li>
                <li class="sub-menu-item text-center"><a href="courses.php">NS</a></li>
                <li class="sub-menu-item text-center"><a href="courses.php">BA</a></li>
        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="banner-text">
              <h2 class="mb-3">
                Một khoản đầu tư vào kiến ​​​thức mang lại lãi suất cao nhất</h2>
              <h1 class="mb-3 text-capitalize">Khoá học chuẩn đại học top đầu </h1>
              <p class="mb-4"> Chúng tôi sẽ đem đến cho bạn một lộ trình giáo dục riêng biệt và hiệu quả nhất bằng công
                nghệ giáo dục trực tuyến hàng đầu Đông Nam Á</p>
              <a href="#" class="btn btn-theme">Học thử miễn phí</a>
            </div>
          </div>
          ...
          <div class="row text-center">
            <div class="col-md-6 col-lg-3">
              <div class="fun-facts-item">
                <h2 class="style1">100k</h2>
                <p>Người theo học</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3">
              <div class="fun-facts-item">
                <h2 class="style2">200+</h2>
                <p>Khoá học</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3">
              <div class="fun-facts-item">
                <h2 class="style3">50+</h2>
                <p>Tỉnh thành</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3">
              <div class="fun-facts-item">
                <h2 class="style4">100+</h2>
                <p>giảng viên giỏi</p>
              </div>
            </div>
          </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 ">
            <div class="section-title text-center">
              <h2 class="title">Các khoá học</h2>
              <p class="sub-title">Các khoá học nổi bật</p>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="courses-item">
              <a href="course-details" class="link">
                <div class="courses-item-inner">
                  ...
                  <h3 class="title">Lập trình web</h3>
                  <div class="instructor">
                    <img src="img/instructor/1.png" alt="instructor img">
    ...
    <section class="testimonials-section section-padding">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="section-title text-center">
              <h2 class="title">Feedback Của Học Viên</h2>
              <p class="sub-title">Học viên của chúng tôi nói gì</p>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 col-lg-6 ">
            ...
            <div class="slideshow-container ">
              ...
              <div class="mySlides fadee text-center mb-3">

                <div class="testimonials-item">
                  <p class="text-1">Từ khi theo dõi trang web UNICOU em đã học được nhiều kiến thức hơn về lập trình, nhiều ngôn ngữ hơn.</p>
                  <h3>Lê Nho Duy</h3>
                  <p class="text-2">Nhân viên công ty FPT Software</p>
                </div>
              </div>

              <div class="mySlides fadee text-center mb-3">
                <div class="testimonials-item">
                  <p class="text-1">Trang web UNICOU là trang web tuyệt vời</p>
                  <h3>Võ Thị Thanh Thuý</h3>
                  <p class="text-2">Sinh viên 5 tốt trường VKU</p>
                </div>
              </div>

              <div class="mySlides fadee text-center mb-3">
                <div class="testimonials-item">
                  <p class="text-1"> Thầy cô và các anh giảng viên rất tích cựu tương tác, em đã tiến bộ rất nhiều </p>
                  <h3>Nguyễn Xuân Hiệu</h3>
                  <p class="text-2">Sinh viên VKU - Giải nhất cuộc thi Spring code của ĐHĐN</p>
                </div>
              </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6">
                  <div class="section-title m-0">
                    <h2 class="title">Trờ Thành Người Hướng Dẫn</h2>
                    <p class="sub-title">Đăng kí làm trợ giảng</p>
                  </div>
